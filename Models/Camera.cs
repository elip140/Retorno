...
namespace Retorno.Models
{
    public class Camera
    {
        ...
        {
            // Da um get no Site e separa as informações coletadas em ControlCard objects. 
            try
            {
            ...
            {
                Logs.ErrorLog("Erro ao pegar as informações do site "+ex,"ERRO");
                return "";
            }
        ...
        public async void SendAllNewRecords(HttpClient _httpClient)
        {
            ...
            {
                Logs.ErrorLog("Erro ao enviar os dados "+ex, "ERRO AO ENVIAR");
            }
